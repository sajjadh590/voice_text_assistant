...
MODEL_PRIORITY: List[str] = [
 "gemini-2.0-flash",           # ✅ باهوش‌ترین و سریع‌ترین مدل رایگان فعلی (پایدار)
    "gemini-2.0-flash-lite",      # ⚡ نسخه سبک سری ۲ (جایگزین ۸b قدیمی - بسیار سریع)
    "gemini-1.5-pro-latest",      # 🧠 نسخه پرو (حتماً پسوند latest اضافه شود تا ۴۰۴ ندهد)
    "gemini-1.5-flash-latest",    # 🛡️ زاپاس مطمئنسریع‌ترین نسخه
]
